...
Compilation options: -a /usr/local/Cellar/faust/2.37.3/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /usr/local/Cellar/faust/2.37.3/share/faust/teensy/teensy.cpp -lang cpp -es 1 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		sig0->fillmydspSIG0(96000, ftbl0);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Grain density", &fHslider1, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.100000001f), FAUSTFLOAT(25.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addHorizontalSlider("Grain length (s)", &fHslider0, FAUSTFLOAT(0.00100000005f), FAUSTFLOAT(0.00100000005f), FAUSTFLOAT(0.75f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addHorizontalSlider("Grain speed", &fHslider4, FAUSTFLOAT(1.0f), FAUSTFLOAT(-3.0f), FAUSTFLOAT(3.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->addHorizontalSlider("Grain start", &fHslider3, FAUSTFLOAT(754.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(96000.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("Rhythm", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (4.65661287e-10f * std::max<float>(0.0f, std::min<float>(1.0f, (1.0f - float(fHslider2)))));
		float fSlow5 = float(fHslider3);
		float fSlow6 = float(fHslider4);
		float fSlow7 = (0.941176474f * fSlow6);
		float fSlow8 = (1.0f / std::max<float>(1.0f, (fConst2 * fSlow1)));
		float fSlow9 = (0.952941179f * fSlow6);
		float fSlow10 = (0.964705884f * fSlow6);
		float fSlow11 = (0.97647059f * fSlow6);
		float fSlow12 = (0.988235295f * fSlow6);
		float fSlow13 = (1.01176476f * fSlow6);
		float fSlow14 = (1.02352941f * fSlow6);
		float fSlow15 = (1.03529418f * fSlow6);
		float fSlow16 = (1.04705882f * fSlow6);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iRec0[0] = (iRec0[1] + 1);
			int iThen0 = (iRec0[0] % 96000);
			ftbl0[(iSlow0 ? 0 : iThen0)] = float(input0[i0]);
			...
			iRec3[0] = (1103515245 * (iTemp8 + 12345));
			int iRec4 = iTemp8;
			int iRec5 = iTemp7;
			int iRec6 = iTemp6;
			int iRec7 = iTemp5;
			...
			int iRec11 = iTemp1;
			int iRec12 = iTemp0;
			fRec2[0] = (fSlow3 + (fRec2[1] - (float(((fSlow3 + fRec2[1]) >= 1.0f)) * ((fSlow4 * float(iRec3[0])) + 1.0f))));
			int iTemp9 = (fRec2[0] < fRec2[1]);
			iVec0[0] = iTemp9;
			fRec1[0] = std::max<float>((fSlow2 * float((iTemp9 != 0))), std::max<float>(0.0f, (fRec1[1] + -1.0f)));
			fRec13[0] = (fSlow7 + fRec13[1]);
			float fElse1 = std::fmod((std::fmod((fSlow5 + std::fmod((fSlow2 + std::fmod(fRec13[0], fSlow2)), fSlow2)), 96000.0f) + 96000.0f), 96000.0f);
			iRec14[0] = (((iRec14[1] + (iRec14[1] > 0)) * (iTemp9 <= iVec0[1])) + (iTemp9 > iVec0[1]));
			float fTemp10 = (fSlow8 * float(iRec14[0]));
			fRec16[0] = (fSlow3 + (fRec16[1] - (float(((fSlow3 + fRec16[1]) >= 1.0f)) * ((fSlow4 * float(iRec4)) + 1.0f))));
			int iTemp11 = (fRec16[0] < fRec16[1]);
			iVec1[0] = iTemp11;
			fRec15[0] = std::max<float>((fSlow2 * float((iTemp11 != 0))), std::max<float>(0.0f, (fRec15[1] + -1.0f)));
			fRec17[0] = (fSlow9 + fRec17[1]);
			float fElse2 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec17[0], fSlow2)), fSlow2) + 9600.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec18[0] = (((iRec18[1] + (iRec18[1] > 0)) * (iTemp11 <= iVec1[1])) + (iTemp11 > iVec1[1]));
			float fTemp12 = (fSlow8 * float(iRec18[0]));
			fRec20[0] = (fSlow3 + (fRec20[1] - (float(((fSlow3 + fRec20[1]) >= 1.0f)) * ((fSlow4 * float(iRec5)) + 1.0f))));
			int iTemp13 = (fRec20[0] < fRec20[1]);
			iVec2[0] = iTemp13;
			fRec19[0] = std::max<float>((fSlow2 * float((iTemp13 != 0))), std::max<float>(0.0f, (fRec19[1] + -1.0f)));
			fRec21[0] = (fSlow10 + fRec21[1]);
			float fElse3 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec21[0], fSlow2)), fSlow2) + 19200.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec22[0] = (((iRec22[1] + (iRec22[1] > 0)) * (iTemp13 <= iVec2[1])) + (iTemp13 > iVec2[1]));
			float fTemp14 = (fSlow8 * float(iRec22[0]));
			fRec24[0] = (fSlow3 + (fRec24[1] - (float(((fSlow3 + fRec24[1]) >= 1.0f)) * ((fSlow4 * float(iRec6)) + 1.0f))));
			int iTemp15 = (fRec24[0] < fRec24[1]);
			iVec3[0] = iTemp15;
			fRec23[0] = std::max<float>((fSlow2 * float((iTemp15 != 0))), std::max<float>(0.0f, (fRec23[1] + -1.0f)));
			fRec25[0] = (fSlow11 + fRec25[1]);
			float fElse4 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec25[0], fSlow2)), fSlow2) + 28800.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec26[0] = (((iRec26[1] + (iRec26[1] > 0)) * (iTemp15 <= iVec3[1])) + (iTemp15 > iVec3[1]));
			float fTemp16 = (fSlow8 * float(iRec26[0]));
			fRec28[0] = (fSlow3 + (fRec28[1] - (float(((fSlow3 + fRec28[1]) >= 1.0f)) * ((fSlow4 * float(iRec7)) + 1.0f))));
			int iTemp17 = (fRec28[0] < fRec28[1]);
			iVec4[0] = iTemp17;
			fRec27[0] = std::max<float>((fSlow2 * float((iTemp17 != 0))), std::max<float>(0.0f, (fRec27[1] + -1.0f)));
			fRec29[0] = (fSlow12 + fRec29[1]);
			float fElse5 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec29[0], fSlow2)), fSlow2) + 38400.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec30[0] = (((iRec30[1] + (iRec30[1] > 0)) * (iTemp17 <= iVec4[1])) + (iTemp17 > iVec4[1]));
			float fTemp18 = (fSlow8 * float(iRec30[0]));
			fRec32[0] = (fSlow3 + (fRec32[1] - (float(((fSlow3 + fRec32[1]) >= 1.0f)) * ((fSlow4 * float(iRec8)) + 1.0f))));
			int iTemp19 = (fRec32[0] < fRec32[1]);
			iVec5[0] = iTemp19;
			fRec31[0] = std::max<float>((fSlow2 * float((iTemp19 != 0))), std::max<float>(0.0f, (fRec31[1] + -1.0f)));
			fRec33[0] = (fSlow6 + fRec33[1]);
			float fElse6 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec33[0], fSlow2)), fSlow2) + 48000.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec34[0] = (((iRec34[1] + (iRec34[1] > 0)) * (iTemp19 <= iVec5[1])) + (iTemp19 > iVec5[1]));
			float fTemp20 = (fSlow8 * float(iRec34[0]));
			fRec36[0] = (fSlow3 + (fRec36[1] - (float(((fSlow3 + fRec36[1]) >= 1.0f)) * ((fSlow4 * float(iRec9)) + 1.0f))));
			int iTemp21 = (fRec36[0] < fRec36[1]);
			iVec6[0] = iTemp21;
			fRec35[0] = std::max<float>((fSlow2 * float((iTemp21 != 0))), std::max<float>(0.0f, (fRec35[1] + -1.0f)));
			fRec37[0] = (fSlow13 + fRec37[1]);
			float fElse7 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec37[0], fSlow2)), fSlow2) + 57600.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec38[0] = (((iRec38[1] + (iRec38[1] > 0)) * (iTemp21 <= iVec6[1])) + (iTemp21 > iVec6[1]));
			float fTemp22 = (fSlow8 * float(iRec38[0]));
			fRec40[0] = (fSlow3 + (fRec40[1] - (float(((fSlow3 + fRec40[1]) >= 1.0f)) * ((fSlow4 * float(iRec10)) + 1.0f))));
			int iTemp23 = (fRec40[0] < fRec40[1]);
			iVec7[0] = iTemp23;
			fRec39[0] = std::max<float>((fSlow2 * float((iTemp23 != 0))), std::max<float>(0.0f, (fRec39[1] + -1.0f)));
			fRec41[0] = (fSlow14 + fRec41[1]);
			float fElse8 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec41[0], fSlow2)), fSlow2) + 67200.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec42[0] = (((iRec42[1] + (iRec42[1] > 0)) * (iTemp23 <= iVec7[1])) + (iTemp23 > iVec7[1]));
			float fTemp24 = (fSlow8 * float(iRec42[0]));
			fRec44[0] = (fSlow3 + (fRec44[1] - (float(((fSlow3 + fRec44[1]) >= 1.0f)) * ((fSlow4 * float(iRec11)) + 1.0f))));
			int iTemp25 = (fRec44[0] < fRec44[1]);
			iVec8[0] = iTemp25;
			fRec43[0] = std::max<float>((fSlow2 * float((iTemp25 != 0))), std::max<float>(0.0f, (fRec43[1] + -1.0f)));
			fRec45[0] = (fSlow15 + fRec45[1]);
			float fElse9 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec45[0], fSlow2)), fSlow2) + 76800.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec46[0] = (((iRec46[1] + (iRec46[1] > 0)) * (iTemp25 <= iVec8[1])) + (iTemp25 > iVec8[1]));
			float fTemp26 = (fSlow8 * float(iRec46[0]));
			fRec48[0] = (fSlow3 + (fRec48[1] - (float(((fSlow3 + fRec48[1]) >= 1.0f)) * ((fSlow4 * float(iRec12)) + 1.0f))));
			int iTemp27 = (fRec48[0] < fRec48[1]);
			iVec9[0] = iTemp27;
			fRec47[0] = std::max<float>((fSlow2 * float((iTemp27 != 0))), std::max<float>(0.0f, (fRec47[1] + -1.0f)));
			fRec49[0] = (fSlow16 + fRec49[1]);
			float fElse10 = std::fmod((std::fmod((fSlow5 + (std::fmod((fSlow2 + std::fmod(fRec49[0], fSlow2)), fSlow2) + 86400.0f)), 96000.0f) + 96000.0f), 96000.0f);
			iRec50[0] = (((iRec50[1] + (iRec50[1] > 0)) * (iTemp27 <= iVec9[1])) + (iTemp27 > iVec9[1]));
			float fTemp28 = (fSlow8 * float(iRec50[0]));
			output0[i0] = FAUSTFLOAT((0.5f * ((((((((((ftbl0[int(((fRec1[0] > 0.0f) ? fElse1 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp10, (2.0f - fTemp10))))))) + (ftbl0[int(((fRec15[0] > 0.0f) ? fElse2 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp12, (2.0f - fTemp12)))))))) + (ftbl0[int(((fRec19[0] > 0.0f) ? fElse3 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp14, (2.0f - fTemp14)))))))) + (ftbl0[int(((fRec23[0] > 0.0f) ? fElse4 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp16, (2.0f - fTemp16)))))))) + (ftbl0[int(((fRec27[0] > 0.0f) ? fElse5 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp18, (2.0f - fTemp18)))))))) + (ftbl0[int(((fRec31[0] > 0.0f) ? fElse6 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp20, (2.0f - fTemp20)))))))) + (ftbl0[int(((fRec35[0] > 0.0f) ? fElse7 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp22, (2.0f - fTemp22)))))))) + (ftbl0[int(((fRec39[0] > 0.0f) ? fElse8 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp24, (2.0f - fTemp24)))))))) + (ftbl0[int(((fRec43[0] > 0.0f) ? fElse9 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp26, (2.0f - fTemp26)))))))) + (ftbl0[int(((fRec47[0] > 0.0f) ? fElse10 : 0.0f))] * (1.0f - std::cos((3.14159274f * std::max<float>(0.0f, std::min<float>(fTemp28, (2.0f - fTemp28))))))))));
			iRec0[1] = iRec0[0];
			iRec3[1] = iRec3[0];
			fRec2[1] = fRec2[0];
			iVec0[1] = iVec0[0];
	...
	FAUST_ADDHORIZONTALSLIDER("Grain density", fHslider1, 2.0f, 0.10000000000000001f, 25.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("Grain length (s)", fHslider0, 0.001f, 0.001f, 0.75f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Grain speed", fHslider4, 1.0f, -3.0f, 3.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Grain start", fHslider3, 754.0f, 0.0f, 96000.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Rhythm", fHslider2, 0.0f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(CHECKBOX, Freeze, "Freeze", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, Grain_density, "Grain density", fHslider1, 2.0f, 0.10000000000000001f, 25.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Grain_length_(s), "Grain length (s)", fHslider0, 0.001f, 0.001f, 0.75f, 0.001f) \
		p(HORIZONTALSLIDER, Grain_speed, "Grain speed", fHslider4, 1.0f, -3.0f, 3.0f, 0.01f) \
		p(HORIZONTALSLIDER, Grain_start, "Grain start", fHslider3, 754.0f, 0.0f, 96000.0f, 1.0f) \
		p(HORIZONTALSLIDER, Rhythm, "Rhythm", fHslider2, 0.0f, 0.0f, 1.0f, 0.01f) \
